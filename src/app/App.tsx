...
export default function App() {
  ...
  return (
    <div style={{
      ...
      /* Winter Chill gradient — light blue fading to white, uniform across entire background */
      background: 'radial-gradient(ellipse at 30% 20%, #90E0EF 0%, #CAF0F8 35%, #ffffff 65%, #ADD8E6 100%)',
