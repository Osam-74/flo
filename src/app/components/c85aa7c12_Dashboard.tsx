...
export function Dashboard({ txs, people, currency, onPersonFilter, onEdit, onDelete }: Props) {
  ...
  return (
    <div style={{ padding: '16px 16px 100px' }}>
      ...
      <div style={{
        background: 'linear-gradient(135deg, #0D2B6E 0%, #1A4FA8 100%)',
        borderRadius: 14, padding: '12px 16px',
        marginBottom: 16,
        boxShadow: '0 4px 16px rgba(26,79,168,0.22)',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <div style={{
            ...
            background: 'rgba(107,143,255,0.22)', border: '1.5px solid rgba(107,143,255,0.4)',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            fontSize: '0.78rem', fontWeight: 800, color: '#90C4FF',
          }}>
            BIZ
          </div>
          <div>
            <div style={{ fontSize: '0.7rem', fontWeight: 800, color: '#A8C4FF', letterSpacing: '0.06em' }}>Biz Account</div>
            <div style={{ fontSize: '0.55rem', color: 'rgba(168,196,255,0.55)', letterSpacing: '0.08em', textTransform: 'uppercase', marginTop: 1 }}>Internal funds held</div>
          </div>
        </div>
        <div style={{ fontFamily: "'DM Mono',monospace", fontSize: '1rem', fontWeight: 600, color: bizBalance >= 0 ? '#CAF0F8' : '#FFB3C0' }}>
