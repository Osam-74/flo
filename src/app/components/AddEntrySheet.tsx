  ...
  useEffect(() => {
    ...
    const onViewportChange = () => {
      ...
      if (currentHeight > prevHeight + 100) {
        // Force drawer back to natural position by clearing any inline transforms
        if (drawerContentRef.current) {
          drawerContentRef.current.style.transform = '';
          drawerContentRef.current.style.transition = 'transform 0.3s cubic-bezier(0.32,0.72,0,1)';
          // Scroll back to top of modal content
          const scrollable = drawerContentRef.current.querySelector('[data-scroll]') as HTMLElement;
          if (scrollable) scrollable.scrollTop = 0;
        }
        // Also blur any focused input to prevent re-trigger
      ...
      <Drawer.Portal>
        ...
        <Drawer.Content
          ...
          style={{
            ...
            background: 'linear-gradient(180deg, #CAF0F8 0%, #ffffff 100%)',
